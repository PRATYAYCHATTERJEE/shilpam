...
},
{
    ...
    jewellery: {
        ...
        cards: [
            ...
            {
                name: "Traditional Jewellery",
                image: "assets/Jwellary/jwellary2.png",
                category: "55",
                price: "₹55",
                link: "terracotta-vase.html"
            },
            {
                name: "Traditional Jewellery",
                image: "assets/Jwellary/jwellary3.png",
                category: "55",
                price: "₹55",
                link: "terracotta-vase.html"
            },
            {
                name: "Traditional Jewellery",
                image: "assets/Jwellary/jwellary4.png",
                category: "55",
                price: "₹55",
                link: "terracotta-vase.html"
            },
...
function renderCraftCategories(category) {

    const container =
        document.getElementById("categoryProducts");

    const title =
        document.getElementById("categorySectionTitle");

    if (!container) return;

    const data =
        craftCategories[category];
...
function initializeCraftTabs() {
    ...
    tabs.forEach(tab => {
        ...
        tab.addEventListener("click", () => {
            ...
            /* Change lower content */

            renderCraftCategories(category);
